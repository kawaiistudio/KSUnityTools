...
namespace KawaiiStudio.VRC
{
    public class KS_Obfuscator : EditorWindow
    {
        ...
        void ExecuteObfuscation()
        {
            ...
            folderPath = "Assets/KS_Protected_" + avatarRoot.name + "_" + Random.Range(100, 999);
            ...
            try 
            {
                ...
                PrefabUtility.SaveAsPrefabAsset(newAvatar, folderPath + "/Avatar_PROTECTED.prefab");
                
                EditorUtility.ClearProgressBar();
                EditorUtility.DisplayDialog("KS SHIELD", "Encryption Complete!\n\nYour protected avatar is in:\n" + folderPath, "Perfect");
            }
